...
SQL Bootcamp в School21 — это введение в язык SQL и базы данных в интенсивном формате: вам нужно выполнять упражнения и представлять свои решения другим студентам каждый день, чтобы добиться успеха в Bootcamp. Каждый модуль (день) в Bootcamp содержит задания, посвященные реализации операторов SQL для извлечения необходимых данных из заданной базы данных.

Система управления базами данных, используемая в Bootcamp, — PostgreSQL.

Я использовал IDE: PgAdmin 4.

## Схема БД

![D01_02](img/schema.png)
